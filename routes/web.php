...
Route::group(['middleware' => ['auth:sanctum']], function () {
  ...
  //ORIGIN
  Route::get('/admin/manage-city', [App\Http\Controllers\Admin\OriginController::class, 'index']);
  ...
  Route::get('/admin/manage-city/delete/{id}', [App\Http\Controllers\Admin\OriginController::class, 'destroy']);

  //PROVINCE
  Route::get('/admin/manage-province', [App\Http\Controllers\Admin\ProvinceController::class, 'index']);
  //Route::get('/admin/manage-province/delete/{id}', [App\Http\Controllers\Admin\ProvinceController::class, 'destroy']);
