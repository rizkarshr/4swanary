        ...
        <div class="container">
            <div class="w3_footer_grids">
                <div class="col-md-3 w3_footer_grid">
                    ...
                    <ul class="address">
                        <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Mirza's Store, Surabaya.</li>
                ...
                <div class="col-sm-3 w3_footer_grid">
                    <h3>Support By</h3>
                    <ul class="info">
                        <li><img src="asset/images/merdeka.png" alt=" " class="img-responsive"></li>
                        <li><img src="asset/images/sekolahekspor.png" alt=" " class="img-responsive"></li>
